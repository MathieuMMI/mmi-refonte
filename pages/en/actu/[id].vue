...
const titre = actupage.value.data.newsen_title[0].text;
const description = actupage.value.data.newsen_desc[0].text;
const date = actupage.value.data.newsen_date[0].text;
